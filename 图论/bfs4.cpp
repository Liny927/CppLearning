...
int dir_id(char c) { return strchr(dirs, c) - dirs; } // 将朝向转换为数字0~3
int turn_id(char c) { return strchr(turns, c) - turns; } // 将转向转换为0~2

const int dr[] = {-1, 0, 1, 0}; // 方向数组
const int dc[] = {0, 1, 0, -1};

Node walk(const Node& u, int turn) {  //状态转移
  int dir = u.dir;
